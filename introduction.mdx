...
We do this by using the [enhance_task](/api-reference/enhance-task) endpoint, which will attach edge cases learned from past interactions stored via the [store_knowledge](/api-reference/store-knowledge) endpoint.
</Tip>
