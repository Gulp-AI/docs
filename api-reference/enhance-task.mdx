...
<ParamField body="input_text" type="string" required initialValue="Process refund request for damaged item">
  The agent's input/query. This can be a user prompt, or the task given to a sub agent.
</ParamField>

<ParamField body="agent_type" type="string" initialValue="support_agent">
