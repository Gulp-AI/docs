...
This endpoint should be used whenever your agent is done performing a task.
If your agent spawns sub sub agents, each sub agent should independently sum up its own results and call this endpoint.
