...
<Note>
  The confidence score in the metadata is currently a simple computation based on our [Monte Carlo Tree Search](https://arxiv.org/abs/2406.03816) process. While it provides a general indication, it should not be treated as a definitive metric of response quality at this stage.
</Note>
