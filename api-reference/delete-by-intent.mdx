...
<ParamField query="tenant_id" type="string" required initialValue="your-api-key">
  The tenant identifier
</ParamField>

<ParamField query="intent" type="string" required initialValue="process refund">
  The intent to match against
</ParamField>

<ParamField query="similarity_threshold" type="number" default="0.5" initialValue={0.7}>
