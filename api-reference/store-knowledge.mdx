...
<ParamField body="query" type="string" required initialValue="Find and purchase a red Nike running shoe in size 10">
...
<ParamField body="success" type="boolean" initialValue={true}>
  Indicates whether the agent completed its task successfully
</ParamField>

<ParamField body="agent_type" type="string" initialValue="browser">
  Specifies the type of agent (e.g., 'browser', 'voice')
</ParamField>

<ParamField body="timestamp" type="string" required initialValue="2024-03-14T10:30:00Z">
...
<ParamField body="turn" type="number" required initialValue={1}>
...
<ParamField body="inputs" type="string" required initialValue="On shopping website homepage. Need to search for red Nike running shoes.">
...
<ParamField body="decision" type="string" required initialValue='{"action_type": "click", "element_name": "search_bar", "text": ["Nike red running shoes"], "element_role": "searchbox", "coords": [120, 35], "url": "https://shop.example.com"}'>
  The output or action taken by the agent during this turn
</ParamField>

<ParamField body="memory" type="string" initialValue="User wants red Nike running shoes. Starting search from homepage.">
